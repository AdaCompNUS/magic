(**NOTE:** This folder's source code was orignally from [here](https://github.com/pranz24/pytorch-soft-actor-critic). It was adapted to work with our tasks and custom environments.)
