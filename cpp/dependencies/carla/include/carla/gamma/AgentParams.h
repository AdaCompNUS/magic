...
struct AgentParams{
	...
	AgentParams(Vector2 _position, float _neighborDist, int _maxNeighbors,
				float _timeHorizon, float _timeHorizonObst, float _radius,
				float _maxSpeed, Vector2 _velocity, std::string _tag,
	...
	static const AgentParams& getDefaultAgentParam(std::string tag){
		...
		static auto create_lookup = []() { //lambda function
			...
			Vector2 ped_position = Vector2(0.0f, 0.0f);
			...
			Vector2 ped_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 scooter_position = Vector2(0.0f, 0.0f);
			...
			Vector2 scooter_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 car_position = Vector2(0.0f, 0.0f);
			...
			Vector2 car_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 van_position = Vector2(0.0f, 0.0f);
			...
			Vector2 van_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 bus_position = Vector2(0.0f, 0.0f);
			...
			Vector2 bus_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 jeep_position = Vector2(0.0f, 0.0f);
			...
			Vector2 jeep_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 bicycle_position = Vector2(0.0f, 0.0f);
			...
			Vector2 bicycle_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 electric_tricycle_position = Vector2(0.0f, 0.0f);
			...
			Vector2 electric_tricycle_velocity = Vector2(0.0f, 0.0f);
			...
			Vector2 gyro_scooter_position = Vector2(0.0f, 0.0f);
			...
			Vector2 gyro_scooter_velocity = Vector2(0.0f, 0.0f);
