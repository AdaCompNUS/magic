...
namespace gamma {
	 ...
	 * of an error by functions in RVOSimulator.
	 */
    ...
    RVOSimulator(const RVOSimulator&) = default;
		 ...
		 *                             this agent.
		 * \return     The number of the agent, or RVO_ERROR when the agent
		 ...
		 *             or RVO_ERROR when the number of vertices is less than two.
